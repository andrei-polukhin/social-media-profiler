...
class TestAnalyzingFacebook(unittest.TestCase):
    facebook_response_to_analyze = {'facebook': [
        {'service_name': 'Facebook Profile', 'link': 'https://www.facebook.com/evan.mccauley.73/',
         'Profile name: ': 'Evan McCauley'},
        {'service_name': 'Facebook Profile', 'link': 'https://www.facebook.com/evan.mccauley.9/',
         'Profile name: ': 'Evan McCauley'},
        {'service_name': 'Facebook Profile', 'link': 'https://www.facebook.com/evan.mccauley.7/',
         'Profile name: ': 'Evan McCauley'},
        {'service_name': 'Facebook Profile', 'link': 'https://www.facebook.com/evan.mccauley.5/',
         'Profile name: ': 'Evan McCauley'},
        {'service_name': 'Facebook Profile', 'link': 'https://www.facebook.com/evan.mccauley/',
