...
class TestDesign(unittest.TestCase):
    ...
    def test_check_existence_of_all_elements(self):
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "first_name_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "last_name_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "location_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "company_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "job_title_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "school_field")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "twitter_field")
        )
        self.assertIsNotNone(
        ...
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QLineEdit, "directory_text")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(
                QtWidgets.QPushButton, "select_directory"
            )
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QPushButton, "submit_button")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(QtWidgets.QAction, "actionCredits")
        )
        self.assertIsNotNone(
            TestDesign.design_object.findChild(
                QtWidgets.QProgressBar, "app_progress_bar"
            )
        )
    ...
    def test_getting_values_from_inputs(self):
        ...
        self.assertIsInstance(
            TestDesign.design_object.additional_text.toPlainText(), str
        )
    ...
    def test_setting_values_to_input_fields(self):
        ...
        # Testing QTextEdit
        initial_value_of_qtext_edit = (
            TestDesign.design_object.additional_text.toPlainText()
        )
    ...
    def test_progress_bar(self):
        progress_bar = TestDesign.design_object.findChild(
            QtWidgets.QProgressBar, "app_progress_bar"
        )
